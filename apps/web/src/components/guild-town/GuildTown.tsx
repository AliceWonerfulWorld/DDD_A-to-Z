...
import { DeployModePanel, GuildTownLoadingOverlay, GuildTownToast } from "./GuildTownOverlays";
...
export function GuildTown({
  ...
  function getRequiredDeploymentLevel(draft: DeploymentDraft, itemWidth: number) {
    return getRequiredPlacementLevel({ draft, itemWidth, mapSize: getMapSize() });
  }
  ...
  function getDeploymentPreview(): DeploymentPreview | null {
    ...
    return {
      ...
      isUnlocked: isPlacementUnlocked({
